...
<div class="modal-header">
			...
			<form id="addForm" action="maintainType/add" method="post">
			<div class="modal-body">

					<div class="form-group">
						<label for="name" class="control-label"><font color="red">*</font>类型名:</label> <input
			 ...
			 $("#addForm").validate({
				 ...
				 submitHandler : function(form){
						   ...
						   // contentType : 'application/json',    //发送信息至服务器时内容编码类型
							//dataType : "json",
							url : "maintainType/add",//请求的action路径  
