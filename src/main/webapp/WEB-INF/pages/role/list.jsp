		...
		<div class="box">
			...
			<div class="box-body">
									...
									<div class="box-body">
										<div class="row">
											...
											<div class="form-group col-md-2">
												<label for="nameLabel">用户名:</label> <input type="text"
				...
				<vino:pagination paginationSize="10" page="${page}"
					action="role/search" contentSelector="#content-wrapper"></vino:pagination>
			</div>
			<!-- /.box -->
		</div>
	</div>
