			...
			<div class="box box-solid">
				...
				<div class="box-body no-padding">
					<ul class="nav nav-pills nav-stacked">
						...
						<li class="active"><a id="readNoticeBtn" href="notice/read"><i
								class="fa fa-envelope-o"></i>已读</a></li>
						<li><a id="pushNoticeBtn" href="notice/preparePush"><i
								class="fa  fa-file-text-o"></i>推送</a></li>
					</ul>
				</div>
				<!-- /.box-body -->
			</div>
				...
				<div class="box-body no-padding">
					...
					<div class="table-responsive mailbox-messages">
						<table class="table table-hover table-striped">
							...
							<tbody>
								<c:forEach var="notice" items="${readNotices}">
									<tr onclick="detailItem(${notice.id})">

										<td class="mailbox-name">${notice.type }</td>
										<td class="mailbox-subject">${notice.content}</td>

										<td class="mailbox-date"><fmt:formatDate
												pattern="yyyy-MM-dd HH:mm:ss" value="${notice.createTime}" /></td>
									</tr>
								</c:forEach>
					...
					<div class="mailbox-controls">
						...
						<div class="pull-right">
							<vino:pagination paginationSize="10" page="${page}"
								action="notice/read" contentSelector="#content-wrapper"></vino:pagination>
