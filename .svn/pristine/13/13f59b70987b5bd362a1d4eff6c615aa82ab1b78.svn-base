...
<script
	src="<%=request.getContextPath()%>/resources/AdminLTE/plugins/daterangepicker/daterangepicker.js"></script>
<script
	src="<%=request.getContextPath()%>/resources/AdminLTE/plugins/datepicker/bootstrap-datepicker.js"></script>
<script
	src="<%=request.getContextPath()%>/resources/AdminLTE/plugins/datepicker/locales/bootstrap-datepicker.zh-CN.js"></script>
	
	
<script
	src="<%=request.getContextPath()%>/resources/js/sockjs-0.3.4.js"></script>
<script
	src="<%=request.getContextPath()%>/resources/js/stomp.js"></script>